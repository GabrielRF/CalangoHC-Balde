...
for post in posts:
    ...
    if days_left == 0:
        ...
        bot.edit_message_caption(desc, groupid, post[1], parse_mode='HTML')
        bot.unpin_chat_message(groupid, sale[1])
    elif int(post[5]) > 0:
        ...
        bot.edit_message_caption(desc, groupid, post[1], parse_mode='HTML', reply_markup=button2)
